...
/*
Szerző: hg2ecz (https://github.com/hg2ecz/proc_speedtest)
Részemről pár apró módosítás: kivettem a hibaüzeneteket, mert azokra nincs szükség, sőt, elrontják az outputot.
*/
